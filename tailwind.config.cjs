...
let macchiato = variants.macchiato;
let mocha = variants.mocha;
let latte = variants.latte;
let frappe = variants.frappe;
	...
	theme: {
		extend: {
			colors: {
				...
				bkgd: "#ffffff", //              'UI background color. All color contrasts evaluated and generated against this color.'round #ffffff'
		...
		themes: [
			{
				...
				mochaOnWhite: {
					...
					bkgd: "#ffffff", //              'UI background color. All color contrasts evaluated and generated against this color.'kground #ffffff'
				...
				mochaOffBlack: {
					...
					bkgd: "#242433", //   'UI background color. All color contrasts evaluated and generated against this color.'15:1 against background #242433'
