...
const frappe = variants.frappe;
const latte = variants.latte;
	...
	theme: {
		extend: {
			colors: {
				...
				'text-1-100': '#797f96', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 67:1 against background #ffffff'
				'text-1-200': '#6e7488', //  'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 72.5:1 against background #ffffff'
				'text-1-300': '#6b7084', //  'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 74.01:1 against background #ffffff'
				'text-1-400': '#535867', //         'Color can be used for small text. WCAG 3 (APCA) contrast is 84.59:1 against background #ffffff'
				'text-1-500': '#454855', //         'Color can be used for small text. WCAG 3 (APCA) contrast is 90.78:1 against background #ffffff'
				'text-1-600': '#22232a', //         'Color can be used for small text. WCAG 3 (APCA) contrast is 102.6:1 against background #ffffff'
				'text-1-700': '#000000', //         'Color can be used for small text. WCAG 3 (APCA) contrast is 108.78:1 against background #ffffff'
		...
		themes: [
			{
				...
				mochaOffBlack: {
					...
					'overlay-1-100': '#a9aebf', //   'Do not use for UI elements or text. WCAG 3 (APCA) contrast is 55.6:1 against background #242433'
					'overlay-1-200': '#b2b6c6', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 60.15:1 against background #242433'
					'overlay-1-300': '#b5b8c8', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 61.4:1 against background #242433'
					'overlay-1-400': '#c4c7d3', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 70.15:1 against background #242433'
					'overlay-1-500': '#cdd0da', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 75.27:1 against background #242433'
					'overlay-1-600': '#e0e1e8', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 85.72:1 against background #242433'
					'overlay-1-700': '#e7e8ed', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 90.16:1 against background #242433'
					'overlay-2-100': '#aeaeae', //   'Do not use for UI elements or text. WCAG 3 (APCA) contrast is 55.6:1 against background #242433'
					'overlay-2-200': '#b6b6b6', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 60.15:1 against background #242433'
					'overlay-2-300': '#b8b8b8', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 61.4:1 against background #242433'
					'overlay-2-400': '#c7c7c7', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 70.15:1 against background #242433'
					'overlay-2-500': '#d0d0d0', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 75.27:1 against background #242433'
					'overlay-2-600': '#e1e1e1', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 85.72:1 against background #242433'
					'overlay-2-700': '#e8e8e8', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 90.16:1 against background #242433'
					'surface-1-100': '#aeaeae', //   'Do not use for UI elements or text. WCAG 3 (APCA) contrast is 55.6:1 against background #242433'
					'surface-1-200': '#b6b6b6', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 60.15:1 against background #242433'
					'surface-1-300': '#b8b8b8', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 61.4:1 against background #242433'
					'surface-1-400': '#c7c7c7', //   'Color can be used for UI elements or large text. WCAG 3 (APCA) contrast is 70.15:1 against background #242433'
					'surface-1-500': '#d0d0d0', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 75.27:1 against background #242433'
					'surface-1-600': '#e1e1e1', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 85.72:1 against background #242433'
					'surface-1-700': '#e8e8e8', //   'Color can be used for small text. WCAG 3 (APCA) contrast is 90.16:1 against background #242433'
